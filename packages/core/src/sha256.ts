// Pure SHA-256 keeps @seatfirst/core usable in Hermes without leaking a Node runtime import.
// The implementation follows FIPS 180-4 and encodes input directly as UTF-8 bytes.
...
/** SHA-256 over a UTF-8 string, returned as 64 lowercase hexadecimal characters. */
