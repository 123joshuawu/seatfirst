  ...
  return (
    ...
    >
      ...
      <MovieField
        ...
        liveScheduleMovies={vm.liveScheduleMovies}
        liveScheduleHeader={vm.liveScheduleHeader}
        nowPlayingSuggestions={vm.nowPlayingSuggestions}
        nowPlayingHeader={vm.nowPlayingHeader}
